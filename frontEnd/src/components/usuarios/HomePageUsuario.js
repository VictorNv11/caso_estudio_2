...
export default function HomePageUsuario() {
    ...
    return (
      ...
      <nav className="sidebar" style={{
        ...
        <h4 style={{ marginLeft: '16px', marginTop:'10%'}}>Usuario</h4>
        <ul className="nav flex-column">
            <li className="nav-item">
                <Link to={'/HomePageUsuario'} className="nav-link active" style={{ color: '#fff' }}><i className="fas fa-home"></i> Inicio</Link>
            </li>
            <li className="nav-item">
                <Link to={'/supAdmins'} className="nav-link" style={{ color: '#fff' }}><i className="fas fa-building"></i> Compañia</Link>
            </li>
            <li className="nav-item">
        ...
        <div className="user-section" style={{
            ...
            <ul className="nav flex-column">
                <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="0" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ color: '#fff' }}>
                        <i className="fas fa-user-circle"></i> Usuario
                    </a>
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a className="dropdown-item"><img src="https://via.placeholder.com/30" alt="Profile" style={{
                            width: '30px',
                            height: '30px',
                            borderRadius: '50%',
                            marginRight: '10px'
          ...
          <div style={{ marginLeft: '260px', padding: '20px', backgroundColor: '#50727B', width: '100%' }}>
              <h1 style={{ marginTop: '5%', color:'white' }}>Esta es la vista de Usuario</h1>
              <div style={{ marginTop: '5%' }}>
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      <div style={{ height: 500, marginLeft: '20px' }}>
                          <h1 style={{ paddingLeft: '10px', color:'white' }}>Usuario</h1>
