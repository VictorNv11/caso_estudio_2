// Librerias de React y useState para el manejo de estados
import React, { useState } from 'react';

// Etiquta link para el enrutamiento
...
const Homepage = () => {
  ...
  // Estado donde mantiene activo el enlace donde nos encontramos
  const [activeSection, setActiveSection] = useState('inicio');

  // Cambio de color en el enlace
          ...
          <header className="navbar navbar-expand-md navbar-dark fixed-top bg-transparent">
            <div className="container">
              <a className="navbar-brand" href="#">
                <img src={Logo} alt="Logo" title='Logo de la Página' style={{ paddingLeft: 20, width: 50, height: 30 }} />
              </a>
          ...
          <section className="py-5 text-" id="about" style={{backgroundColor:'#50727B'}}>
            <div className="container">
              ...
              <p 
                ...
                Descubre una nueva forma de gestionar tus usuarios. Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Voluptate deserunt fugit recusandae earum perferendis quaerat? Eaque repudiandae vero quas fuga, praesentium inventore tempora maxime, 
                atque neque illum molestias ducimus pariatur?
              ...
              <p 
                style={{ textAlign: 'left', color: "#ffff" }}>
                  Experimenta la mejor plataforma de administración de usuarios. Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                  Minima assumenda quaerat iste consequatur possimus dolorem incidunt in molestiae ipsam inventore doloremque, delectus nisi pariatur. 
                  Earum excepturi consequuntur veritatis suscipit quos.
              </p>
